Feature: Test the Add, Search and Delete Location Feature
    As a developer
    ...
    Scenario: Search and Delete Location Feature
		...
		And   I expect that checkbox "#ohrmList_chkSelectRecord_6" is not checked
		And   I click on the element "#ohrmList_chkSelectRecord_6"
